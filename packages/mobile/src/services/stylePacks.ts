...
export const stylePacks: StylePack[] = [
  // ─── Story Portrait (trending personalized caricature) ────────────
  {
    ...
    description: 'The viral "Me & My Job" look — cartoon you with big head surrounded by your life symbols',
    previewColor: '#E8A838',
    proOnly: false,
  },
  {
    id: 'story-portrait-collage',
    displayName: 'Story Portrait — Max',
    category: 'Story Portrait',
    icon: '\uD83C\uDF1F',
    thumbnail: styleAssets['story-portrait-collage'],
    description: 'Same cartoon style but packed edge-to-edge with even more symbols, banners & badges',
    previewColor: '#E17055',
    proOnly: true,
  },
  {
    id: 'story-portrait-minimal',
    displayName: 'Story Portrait — Elegant',
    category: 'Story Portrait',
    icon: '\u2728',
    thumbnail: styleAssets['story-portrait-minimal'],
    description: 'Refined version — natural proportions, fewer objects, clean & classy',
    previewColor: '#00B894',
    proOnly: true,
  },
